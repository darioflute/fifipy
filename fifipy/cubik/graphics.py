...
class SpectrumCanvas(MplCanvas):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ax1.set_xlabel('Wavelength [$\\mu$m]')
        self.ax2.set_ylabel('Flux')
        self.ax3.set_ylabel('N')
    ...
    def drawSpectrum(self):
        ...
        for ax in [self.ax1, self.ax2]:
            ax.plot(s.wave, s.flux, color='blue', label='Cube')
            ax.plot(s.wave, s.fflux, color='green', label='Filter')  
        self.ax2.legend()
        self.ax3.plot(s.wave, s.nflux)
        self.draw_idle()